...
import tiane.org.ssm.service.BizOrdersService;
 ...
 */
@RestController
@RequestMapping("/api/order_r2")
@Api(value="/api/order_r2",description="国内订单API")
public class BizOrdersR2Controller {
    @Autowired
    private BizOrdersR2Service bizOrdersService;
    ...
    @GetMapping("/list")
    public Result<IPage<BizOrdersR2>> list(
        ...
        Page page = new Page<BizOrdersR2>(Integer.parseInt(current),Integer.parseInt(size));
    ...
    public Result<List<BizOrdersR2>> getOrdersByCode(@RequestParam(name = "orderCode") String orderCode){
